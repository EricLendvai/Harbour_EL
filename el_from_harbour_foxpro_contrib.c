...
// Modified the functions name to be prefixed with "EL_"

/*
 * FoxPro compatible functions BETWEEN(), INLIST()
 *
 * Copyright (c) 2024 Eric Lendvai Modifed __FOX_SEEK to Create EL_SEEK
...
// The EL_SEEK is a modified version of __FOX_SEEK VFP does not handle SoftSeek and FindLast, and the order of parameter is different.
